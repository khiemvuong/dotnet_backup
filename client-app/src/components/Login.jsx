...
function Login({ handleLoginClick, handleCloseClick }) {
  ...
  return (
    <div className="login flex flex-col w-[500px] h-[300px] bg-black border-4 rounded-2xl border-red fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-[1000]">
      ...
      <div className="border-t-2 border-red w-full self-center mt-[12px]" />
      <div className="w-full flex flex-col mt-[40px] items-center space-y-4">
        <div className="username flex flex-row items-center w-[400px] h-[36px] rounded-full bg-black border-gray border-2 focus:outline-none focus:ring-1 focus:ring-white px-4">
          <img src={UsernameImg} alt="Username Icon" className="w-4 h-4 mr-4" />
          <input
            type="text"
            className="text-sm text-gray w-full bg-transparent focus:outline-none"
            placeholder="Username"
            // value={}
            // onChange={}
          />
        </div>
        <div className="password flex flex-row items-center w-[400px] h-[36px] rounded-full bg-black border-gray border-2 focus:outline-none focus:ring-1 focus:ring-white px-4">
        ...
        <div className="flex flex-row items-center w-full justify-center">
          <button
            className="LoginBtn mt-2 w-[190px] h-9 border-2 border-red bg-red text-black text-[16px] font-bold rounded-full items-center justify-center tracking-widest hover:bg-dark-red hover:border-dark-red duration-200"
